      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/home/#home') }}">Home</a>
            </li>
            <li class="nav-item">
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/home/#about-us') }}">About Us</a>
            </li>
            <li class="nav-item">
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/home/#doctors') }}">Doctors</a>
            </li>
            <li class="nav-item">
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/home/#blog') }}">News</a>
            </li>
            <li class="nav-item">
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/home/#appointments') }}">Appointments</a>
            </li>
